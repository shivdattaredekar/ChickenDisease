...
# Initally the .github will be blank hence we created one more file .gitkeeps to make sure pushing happnes. later we can delete this file
# __init__ is created to make sure that project_name become the local package hence we will be able to import anything from project_name
